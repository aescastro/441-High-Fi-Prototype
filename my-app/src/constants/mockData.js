...
export const balance30YearLevel = [
    [
      {name:"Zack",yearLevel:2,yoe:7,skills:["HTML","CSS","Redux","Express"]},
      {name:"Derek",yearLevel:2,yoe:6,skills:["JavaScript","Java","Git","Vue.js"]},
      {name:"Liam",yearLevel:3,yoe:5,skills:["Java","SQL","React","AWS"]},
	  {name:"Leo",yearLevel:4,yoe:5,skills:["React","Node.js","MongoDB","JIRA"]},
      {name:"Wendy",yearLevel:1,yoe:8,skills:["Java","SQL","AWS","Python"]}	  
    ],
    [
      {name:"Alice",yearLevel:4,yoe:6,skills:["JavaScript","React","CSS","MongoDB"]},
      {name:"Emma",yearLevel:1,yoe:7,skills:["React","Node.js","MongoDB","Git"]},
      {name:"Ivy",yearLevel:1,yoe:8,skills:["Python","Java","React","Angular"]},
      {name:"Mia",yearLevel:3,yoe:5,skills:["HTML","CSS","AWS","Scrum"]},
      {name:"Quinn",yearLevel:2,yoe:5,skills:["JavaScript","HTML","CSS","Webpack"]}
    ],
    [
      {name:"Rachel",yearLevel:3,yoe:7,skills:["Java","SQL","React","JIRA"]},
      {name:"Tom",yearLevel:3,yoe:6,skills:["HTML","CSS","Redux","Express"]},
      {name:"Xavier",yearLevel:1,yoe:8,skills:["JavaScript","Java","Git","Vue.js"]},
      {name:"Yasmine",yearLevel:4,yoe:5,skills:["React","Node.js","Redux","Express"]},
      {name:"Zane",yearLevel:2,yoe:5,skills:["Python","Docker","MongoDB","Angular"]}
    ],
    [
      {name:"Charlie",yearLevel:4,yoe:5,skills:["HTML","CSS","Node.js","Express"]},
      {name:"Grace",yearLevel:1,yoe:6,skills:["Java","SQL","AWS","Vue.js"]},
      {name:"Katie",yearLevel:2,yoe:7,skills:["JavaScript","Java","SQL","Docker"]},
      {name:"Olivia",yearLevel:3,yoe:8,skills:["React","Node.js","Redux","Express"]},
      {name:"Sam",yearLevel:2,yoe:5,skills:["Python","Node.js","Redux","Scrum"]}
    ],
    [
       {name:"Henry",yearLevel:4,yoe:8,skills:["React","Node.js","Java","Webpack"]},
      {name:"Vince",yearLevel:2,yoe:8,skills:["JavaScript","HTML","CSS"]},
      {name:"Peter",yearLevel:3,yoe:6,skills:["Python","Docker","MongoDB","Angular"]},
      {name:"Tina",yearLevel:1,yoe:5,skills:["HTML","CSS","Docker","RESTful API"]},
	  {name:"Gina",yearLevel:3,yoe:5,skills:["HTML","CSS","Docker","RESTful API"]}
    ...
    [
      ...
      {name:"Ingrid",yearLevel:1,yoe:7,skills:["Python","Node.js","Redux","Scrum"]},
      {name:"Hank",yearLevel:2,yoe:5,skills:["Java","SQL","React","JIRA"]},
      {name:"Frank",yearLevel:3,yoe:5,skills:["JavaScript","HTML","CSS"]}
    ]
  ]

export const balance50Yoe = [
    [
    ...
    [
      {name:"Alice",yearLevel:1,yoe:2,skills:["JavaScript","React","CSS","MongoDB"]},
      {name:"Emma",yearLevel:1,yoe:7,skills:["React","Node.js","MongoDB","Git"]},
      {name:"Ivy",yearLevel:1,yoe:8,skills:["Python","Java","Git","Angular"]},
      {name:"Mia",yearLevel:1,yoe:5,skills:["HTML","CSS","AWS","Scrum"]},
      {name:"Quinn",yearLevel:1,yoe:10,skills:["JavaScript","HTML","CSS","Webpack"]}
    ],
    [
      {name:"Rachel",yearLevel:2,yoe:7,skills:["Java","SQL","React","JIRA"]},
    ...
    [
      {name:"Charlie",yearLevel:3,yoe:3,skills:["HTML","CSS","Node.js","Express"]},
      {name:"Grace",yearLevel:3,yoe:6,skills:["Java","SQL","AWS","Vue.js"]},
      {name:"Katie",yearLevel:3,yoe:7,skills:["JavaScript","Java","SQL","Docker"]},
      {name:"Olivia",yearLevel:3,yoe:8,skills:["React","Node.js","Redux","Express"]},
      {name:"Sam",yearLevel:3,yoe:10,skills:["Python","Node.js","Redux","Scrum"]}
    ],
    [
      {name:"David",yearLevel:4,yoe:2,skills:["Python","Docker","Redux","RESTful API"]},
      {name:"Henry",yearLevel:4,yoe:3,skills:["React","Node.js","MongoDB","Webpack"]},
      {name:"Leo",yearLevel:4,yoe:5,skills:["React","Node.js","MongoDB","JIRA"]},
